...
\addcontentsline{toc}{subsection}{material:exchange-matrix-5th-nn}
Defines the pairwise exchange energy between atoms of type index and
...
\addcontentsline{toc}{subsection}{material:exchange-matrix-6th-nn}
Defines the pairwise exchange energy between atoms of type index and
...
\addcontentsline{toc}{subsection}{material:exchange-matrix-7th-nn}
Defines the pairwise exchange energy between atoms of type index and
...
\addcontentsline{toc}{subsection}{material:exchange-matrix-8th-nn}
Defines the pairwise exchange energy between atoms of type index and
...
\addcontentsline{toc}{subsection}{material:exchange-matrix-9th-nn}
Defines the pairwise exchange energy between atoms of type index and
neighbour-index for the ninth nearest neighbour shell when using the built in
exchange functions. See 2nd neighbour description for more details on using this feature.


{\zicf material:exchange-matrix-10th-nn[index] = float [default 0.0 J/link]}
\addcontentsline{toc}{subsection}{material:exchange-matrix-10th-nn}
Defines the pairwise exchange energy between atoms of type index and
...
\addcontentsline{toc}{subsection}{material:second-uniaxial-anisotropy-constant}
