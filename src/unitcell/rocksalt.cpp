...
void build_rock_salt(unitcell::unit_cell_t& unit_cell){
   ...
   unit_cell.atom[0].mat = uc::internal::sublattice_materials ? 0 : 0; // if sublattice material is defined, then identify as metal sublattice 0
   ...
   unit_cell.atom[1].mat = uc::internal::sublattice_materials ? 4 : 1; // if sublattice material is defined, then identify as Oxygen
   ...
   unit_cell.atom[2].mat = uc::internal::sublattice_materials ? 4 : 1; // if sublattice material is defined, then identify as Oxygen
   ...
   unit_cell.atom[3].mat=uc::internal::sublattice_materials ? 1 : 0; // if sublattice material is defined, then identify as metal sublattice 1
   ...
   unit_cell.atom[4].mat = uc::internal::sublattice_materials ? 4 : 1; // if sublattice material is defined, then identify as Oxygen
   ...
   unit_cell.atom[7].mat = uc::internal::sublattice_materials ? 4 : 1; // if sublattice material is defined, then identify as Oxygen
