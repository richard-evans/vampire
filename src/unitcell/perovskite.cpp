...
void build_perovskite(unitcell::unit_cell_t& unit_cell){
   ...
   unit_cell.atom.resize(5);
   unit_cell.surface_threshold=18;
   //-----------------------------
   // Ca site
   //-----------------------------
   ...
   unit_cell.atom[3].y=0.0;
   unit_cell.atom[3].z=0.5;
   unit_cell.atom[3].mat = uc::internal::sublattice_materials ? 3 : 2; // if sublattice material is defined, then identify at as same as ID
   ...
   unit_cell.atom[4].mat = uc::internal::sublattice_materials ? 4 : 2; // if sublattice material is defined, then identify at as same as ID
