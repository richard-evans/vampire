...
// Note: includes code modified from interactions.cpp and spinel.cpp
...
// This function initialises a unit cell instance of NdFeB
...
void build_NdFeB_Cell(unitcell::unit_cell_t& unit_cell){
   ...
   unit_cell.lcsize = 68;
   unit_cell.hcsize = 4;
   unit_cell.interaction_range = 1;   // This seems appropriate considering the exchange interaction range and the size of the unit cell.
