            ...
            */
            ...
            //these are taken from previous functions in VAMPIRE
             ...
             for(int i=start_index;i<end_index; i++){
               ...
               sld::internal::fields_array_x[i]+=atoms::x_total_external_field_array[i];
               sld::internal::fields_array_y[i]+=atoms::y_total_external_field_array[i];
               sld::internal::fields_array_z[i]+=atoms::z_total_external_field_array[i];
