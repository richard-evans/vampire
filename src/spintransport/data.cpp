...
namespace spin_transport{
   ...
   namespace internal{
      ...
      std::vector < std::vector <double> > cell_sl_magnetization;        // 3N normalised magnetization of each material in each cell
      ...
      std::vector < std::vector <double> > cell_sl_spin_torque_fields;   // 3N array of cell spin torque fields
