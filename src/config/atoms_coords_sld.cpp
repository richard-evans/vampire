...
void atoms_coords_sld(){
   ...
   if(config::internal::num_io_groups == 1) file_sstr << "atoms-coords-sld-" << std::setfill('0') << std::setw(8) << sim::output_atoms_file_counter << ".data";
   // otherwise set indexed files
   else{
      file_sstr << "atoms-coords-sld-" << std::setfill('0') << std::setw(8) << sim::output_atoms_file_counter << "-" <<
