...
void atoms_new()
{
   ...
   // Output Meta Data
      ...
      int files = 1; // vmpi::num_io_processors;
      if (vmpi::my_rank == 0)
      ...
      std::vector<float> localbuffer(local_size);
      ...
      }else
      {
            ...
            std::vector<float> total_buffer(total_size);
            ...
            write_data(total_buffer);
      }
   #else
      write_data(localbuffer);
