...
namespace config{
   ...
   void config(){
      ...
      if(err::check==true){std::cout << "config::config has been called" << std::endl;}
   ...
   namespace internal{
      ...
      void atoms(){
         ...
         // check calling of routine if error checking is activated
         if(err::check==true){std::cout << "config::atoms has been called" << std::endl;}
      ...
      void atoms_coords(){
         ...
         // check calling of routine if error checking is activated
         if(err::check==true){std::cout << "config::atoms_coords has been called" << std::endl;}
