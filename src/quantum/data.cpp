...
namespace quantum{
   ...
   namespace internal{
      ...
      std::vector<double> material_S0_array; // compact array of spin magnitude for each material
      std::vector<double> material_inv_sqrt_S0_array; // compact array of inverse sqrt of spin magnitude for each material
