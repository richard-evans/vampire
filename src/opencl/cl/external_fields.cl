...
void update_external_fields(const __global int *const restrict material,
                            ...
                            const __global real_t *const restrict x_dip_field,
                            const __global real_t *const restrict y_dip_field,
                            const __global real_t *const restrict z_dip_field,
                            __global real_t *const restrict x_ext_field,
                            __global real_t *const restrict y_ext_field,
                            __global real_t *const restrict z_ext_field,
