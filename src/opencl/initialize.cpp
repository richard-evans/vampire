...
static void handle_error(const cl::Error &error)
{
...
namespace vopencl
{
   ...
   namespace internal
   {
      bool initialize_atoms(void)
      {
         try
         {
            const cl::CommandQueue write_q = cl::CommandQueue(vcl::context, vcl::default_device);
            ...
            vcl::atoms::spin_array = vcl::Buffer3D(vcl::context, write_q,
                                                   vcl::read_write,
                                                   ::atoms::x_spin_array,
                                                   ::atoms::y_spin_array,
                                                   ::atoms::z_spin_array);
            ...
            vcl::atoms::coord_array = vcl::Buffer3D(vcl::context, write_q,
                                                    vcl::read_write,
                                                    ::atoms::x_coord_array,
                                                    ::atoms::y_coord_array,
                                                    ::atoms::z_coord_array);
      ...
      bool initialize_rng(void)
      {
         try
         {
            ...
            std::vector<cl_uint> rs(::atoms::num_atoms*3);

            const size_t u_buffer_size = rs.size() * sizeof(cl_uint);
