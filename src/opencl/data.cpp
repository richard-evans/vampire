...
namespace vopencl
{
   ...
   namespace internal
   {
      ...
      namespace atoms
      {
         vcl::Buffer3D<vcl_real_t, vcl_real_vec_t> spin_array;

         vcl::Buffer3D<vcl_real_t, vcl_real_vec_t> coord_array;
      ...
      namespace cells
      {
         ...
         vcl::Buffer3D<vcl_real_t, vcl_real_vec_t> mag_array;

         vcl::Buffer3D<vcl_real_t, vcl_real_vec_t> field_array;
      ...
      vcl::Buffer3D<vcl_real_t, vcl_real_vec_t> total_spin_field_array;

      vcl::Buffer3D<vcl_real_t, vcl_real_vec_t> total_external_field_array;

      vcl::Buffer3D<vcl_real_t, vcl_real_vec_t> dipolar_field_array;
