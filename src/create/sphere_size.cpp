...
namespace internal{
   ...
   //---------------------------------------------------------------------------
   // Special version of spherical particle maker for agglomorates with
   // variable particle size
   //---------------------------------------------------------------------------
   void sphere_size(std::vector<double>& particle_origin,
                    std::vector<cs::catom_t> & catom_array,
                    const int grain,
                    const double agg_particle_scale
                 ){

   	// Set particle radius
   	double particle_radius_squared = (agg_particle_scale*0.5)*(agg_particle_scale*0.5);
